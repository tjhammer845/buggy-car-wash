            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav pt-4 p-lg-0 ml-auto">
                        <li class="nav-item pl-4 pr-4 p-lg-0 ml-lg-4 active">
    ...
    <main class="content w-100">
        ...
        <section class="welcome-section">
            <div class="container">
                <div class="row mb-4">
                    <div class="col-12">
                        <h1 class="mt-5">Welcome to Buggy Car Wash</h1>
                        <p class="lead">
                            Buggy Car Wash is a professional, locally owned and operated car
                            and dog wash in North Haven, Connecticut. Protect the finish of
                            your vehicle with our advanced touch-free wash equipment. Our
                            newest Ultimate Platinum Wash will keep your car or truck
                            spotless. And don’t miss our new self-service dog wash rooms.
                        </p>
                    </div>
                </div>
                <div class="d-none d-sm-block row mb-5">
                    <div class="col-12">
                        <div class="card-deck">
                            <div class="card bg-white border border-warning">
                                <div class="card-body">
                                    <img class="d-block ml-auto mr-auto mt-4 mb-4" alt="Touch-Free Car Wash"
                                        src="./assets/images/icons/car-wash-icon.png">
                                    <h3 class="card-title">Touch-Free Car Wash</h3>
                                    <p class="card-text">
                                        With undercarriage wash, rocker panel and wheel blaster, hot foaming presoak,
                                        high
                                        pressure
                                        laser wash, Platinum triple foam, Platinum total vehicle protection, final rinse
                                        and
                                        laser
                                        dry cycles.</p>
                                </div>
                            ...
                            <div class="card bg-white border border-warning">
                                <div class="card-body">
                                    <img class="d-block ml-auto mr-auto mt-4 mb-4" alt="Self-Service Bays"
                                        src="./assets/images/icons/service-icon.png">
                                    <h3 class="card-title">Self-Service Bays</h3>
                                    <p class="card-text">
                                        Try our most economical wash. Our self-service bays are huge. Bring your car,
                                        truck,
                                        trailer
                                        or boat. Open 24 hours for your convenience.</p>
                                </div>
                            </div>
                            <div class="card bg-white border border-warning">
                                <div class="card-body">
                                    <img class="d-block ml-auto mr-auto mt-4 mb-4" alt="Gift Cards"
                                        src="./assets/images/icons/gift-card-icon.png">
                                    <h3 class=" card-title">Gift Cards</h3>
                                    <p class="card-text">
                                        Buggy Car Wash Pre-Paid Gift Cards make the perfect gift for any occasion.
                                        So the more you buy, the more you save!</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Services Section -->
        <section class="services-section primary-gradient">
            <div class="container">
                <div class="row m-0">
                    <div id="accordion" class="mt-5 w-100" role="tablist">
                        <div id="softTouch" class="card mb-4">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                <div class="card-body">
                                    <p class="lead mb-4">
                                        Come experience our new soft touch car wash. With features like the Top
                                        and Side Blasters, Tire Scrubber, Triplex Wheel Cleaner and Weather
                                        Guard Sealant, it is
                                        our most advanced car
                                        wash yet. Weather permitting, we are open 24 hours for your convenience.
                                    </p>
                                    <table role="table" class="table table-soft-touch table-striped" cellspacing="0"
                                        cellpadding="0">
                                        <thead role="rowgroup">
                                            <tr role="row">
                                                <th class="display-3 border-top-0" role="columnheader">
                                                    Wash<br> Cycles</th>
                                                <th class="best-deal display-4 text-uppercase border border-warning border-top-0 border-bottom-0 p-0"
                                                    role="columnheader">
                                                    Ultimate <div class="display-2">$15</div>
                                                </th>
                                                <th class="display-4 text-uppercase border-top-0" role="columnheader">
                                                    Supreme <div class="display-2">$13</div>
                                                </th>
                                                <th class="display-4 text-uppercase border-top-0" role="columnheader">
                                                    Deluxe <div class="display-2">$11</div>
                                                </th>
                                                <th class="display-4 text-uppercase border-top-0" role="columnheader">
                                                    Express <div class="display-2">$9</div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody role="rowgroup">
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Top and Side Blasters
                                                </td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell">
                                                    <i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Tire Scrubber</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Triplex Wheel Cleaner
                                                </td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Presoak</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Soft Cloth Wash</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Triple Polish
                                                    Protection</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Weather Guard Sealant
                                                </td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Final Rinse</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Laser Dry</td>
                                                <td class="text-center border border-warning border-top-0" role="cell">
                                                    <i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                        ...
                        <div id="touchFree" class="card mb-4">
                            ...
                            <div id="collapseTwo" class="collapse show" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="card-body">
                                    <p class="lead mb-4">
                                        Our Touch-Free Auto Wash. You don’t even have to get out of your car.
                                        Just drive
                                        through and
                                        enjoy this powerful automated technology. Weather permitting, we are
                                        open 24
                                        hours for your
                                        convenience.
                                    </p>
                                    <table role="table" class="table table-touch-free table-striped" cellspacing="0"
                                        cellpadding="0">
                                        <thead role="rowgroup">
                                            <tr role="row">
                                                <th class="display-3 border-top-0" role="columnheader">
                                                ...
                                                <th class="display-4 text-uppercase border-top-0" role="columnheader">
                                                    Supreme <div class="display-2">$12</div>
                                                </th>
                                                <th class="display-4 text-uppercase border-top-0" role="columnheader">
                                                    Deluxe <div class="display-2">$10</div>
                                                </th>
                                                <th class="display-4 text-uppercase border-top-0" role="columnheader">
                                                    Express <div class="display-2">$8</div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody role="rowgroup">
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Undercarriage Wash</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                                <td class="text-center" role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Rocker Panel and Wheel
                                                    Super
                                                    Blaster</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Double Pass Hot Foaming
                                                    Presoak
                                                </td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">High Pressure Laser
                                                    Wash</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Platinum Triple Foam
                                                </td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                                            ...
                                            <tr role="row">
                                                <td class="font-weight-bold" role="cell">Platinum Total Vehicle
                                                    Protection</td>
                                                <td class="text-center border border-warning border-top-0 border-bottom-0"
                                                    role="cell"><i class="fas fa-check-circle"></i>
                                                </td>
                        ...
                        <div id="selfService" class="card mb-5">
                            ...
                            <div id="collapseThree" class="collapse show" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <p class="lead mb-3 mb-lg-4">
                                        Our Touch-Free Auto Wash. You don’t even have to get out of your car. Just
                                        drive
                                        through and
                                        enjoy this powerful automated technology. Weather permitting, we are open 24
                                        hours for your
                                        convenience.
                                    </p>
                                    <div class="d-lg-flex">
                                        <div class="flex-fill pr-sm-2 pr-md-4 mb-4 mb-lg-2 mt-0">
                                            <div class="line-height-default display-1 text-left">$3.25</div>
                                            <div class="line-height-default display-4 text-left text-uppercase">For 5
                                                minutes</div>
                                        </div>
                                        <table role="table" class="table table-self-service table-striped flex-fill">
                                            <tbody role="rowgroup">
                                                <tr role="row">
                                                    <td role="cell">
                                                        <div class="d-flex flex-wrap align-content-center"><i
                                                                class="fas fa-check-circle pl-2 pl-lg-4 mr-3"></i>
                                                            bug off
                                                        </div>
                                                    </td>
                                                    <td role="cell">
        ...
        <section class="testimonials-section">
            <div class="container pt-5 pb-5">
                <div class="row">
                    <div id="testimonialCarousel" class="carousel slide w-100 pb-5" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active text-center p-4">
                                <blockquote class="blockquote text-center">
                                    <p class="mb-0"><i class="fa fa-quote-left"></i> &nbsp; Fabulous work! Looks like a
                                        brand
                                        new car. Will definitely use them again. Thanks again Mike! &nbsp; <i
                                            class="fa fa-quote-right"></i>
                                    </p>
                                    <footer class="blockquote-footer mb-3"><strong>George McTearney</strong>
                            ...
                            <div class="carousel-item text-center p-4">
                                <blockquote class="blockquote text-center">
                                    <p class="mb-0"><i class="fa fa-quote-left"></i> &nbsp; Seven years of kids’ abuse
                                        disappeared
                                    ...
                                    <footer class="blockquote-footer mb-3"><strong>Dan Nahikian</strong>
                            ...
                            <div class="carousel-item text-center p-4">
                                <blockquote class="blockquote text-center">
                                    <p class="mb-0"><i class="fa fa-quote-left"></i> &nbsp; All I can say is that was
                                        amazing.
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="contact-image">
                            <img class="p-3" src="./assets/images/icons/bubbles.gif" alt="Buggy Bubbles" />
                        </div>
                    </div>
                </div>
                <div class="row">
